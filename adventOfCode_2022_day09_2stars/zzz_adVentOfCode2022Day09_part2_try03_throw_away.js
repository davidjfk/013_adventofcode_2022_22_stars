/*
    ...
    status: fn calculateNewXAndYCoordinateOfFollowingTailKnot is working
    next: implement for all case statements  of method  movefRopeTailOnRopeBridgeOneStepAtATime
    ...
    movefRopeTailOnRopeBridgeOneStepAtATime(motionOfRopeHeadOfRopeBridge) {
        ...
        switch(directionOfMovement){
            ...
            case 'R':
                ...
                const calculateNewXAndYCoordinateOfFollowingTailKnot = (xLeadingKnot, yLeadingKnot, xFollowingTailKnot, yFollowingTailKnot) => {   
                       ...
                       yLeadingKnot - yFollowingTailKnot == 0)
                    {
                        ...
                        // (Math.abs(xLeadingKnot - xFollowingTailKnot) == 1) 
                        // && 
                        /* 
                            pitfall: do NOT check the value of xCoordinateOfHeadInGrid nor xFollowingTailKnot.
                        ...
                        */
                        ...
                        this.gridToPlotPositionOf9TailsWithForEachGridCellABooleanIsVisited[xFollowingTailKnot][yFollowingTailKnot] = true;
                ...
                let newCoordinatesOfRopeLeadingAndFollowingKnot = calculateNewXAndYCoordinateOfFollowingTailKnot(this.xCoordinateOfHeadInGrid, this.yCoordinateOfHeadInGrid, this.xCoordinateOfTailInGrid, this.yCoordinateOfTailInGrid)
                ...
                */
                ...
                // this.gridToPlotPositionOf9TailsWithForEachGridCellABooleanIsVisited[newCoordinatesOfRopeLeadingAndFollowingKnot[2]][newCoordinatesOfRopeLeadingAndFollowingKnot[3]] = true;
                ...
                // this.xCoordinateOfTail1InGrid =   newCoordinatesOfRopeLeadingAndFollowingKnot[0];
                // this.yCoordinateOfTail1InGrid =   newCoordinatesOfRopeLeadingAndFollowingKnot[1];
                // this.xCoordinateOfTailInGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot[2];
                // this.yCoordinateOfTailInGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot[3];
                /*
                    goal: update rope-tail-coordinates so it can be reused for:
                    a) the next instruction (e.g. R 4 in input1.txt):
                */
                ...
                // this.gridToPlotPositionOf9TailsWithForEachGridCellABooleanIsVisited[this.xCoordinateOfTail2InGrid][this.yCoordinateOfTail2InGrid ] = true;
