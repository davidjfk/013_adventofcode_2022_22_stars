/*
    ...
    GOAL: (piece de resistance) make the code work with 1 rope-head-object and 9 rope-tails instead of the current
            1 rope-head-object with 1 rope-tail-object. So up until here the code is still outputting the correct 
            output of day 9 part 1. What has changed is that I can now quickly add as many rope-tails (inside each
            case statement of method movefRopeTailOnRopeBridgeOneStepAtATime ) as needed (i.e. 9 in total.)
            This is the last task of the design STEP3 below.


    problem 1: based on analyzing the console.log-data, I have figured out that rope-head and rope-tail-1 has 12 directions in which to move, but 
    rope-tails 3-10 can move in 20 directions (!!). I have added a comment about this inside the case statements of method 
    movefRopeTailOnRopeBridgeOneStepAtATime.

    improvement: if x and y adjacent, then nothing needs to happen. So I have skipped the if-condition in which x and y are adjacent.
    

    status: code is ready to test with input2.txt (=== real input data from adventOfCode day 9 ). 

    problem: (after reading the requirements more carefully...)
    You must only count the grid positions that tail 9 has visited.
    Currently I count them all...(total: 6365)...but that is not the question.
    
    solution: adjust how calculation takes place inside method movefRopeTailOnRopeBridgeOneStepAtATime (=== quick fix).

    status: I will implement solution in part2_try05.js
    ...
    2. gridToPlotPositionOfTailWithForEachGridCellABooleanIsVisited --> new name:   
       gridToPlotPositionOf9TailsWithForEachGridCellABooleanIsVisited
   ...
   STEP3:  each object (always a tail object) uses the  output of the previous object (head or tail object) as its input. 
            ...
            ALL 9 rope-tail-objects for each step of the rope-head-object.

            How to do this: 
            1. implement fn calculateNewXAndYCoordinateOfComparatorTailKnot to calculate 1st rope-tail-coordinates. Do this 
                inside switch statement for (first) case R, then case U, then case L, then case D. Reason: then I can use
                input1.txt to test the code during the implementation (first 4 instructions are R 4, U 4, L 3, D 1). Reason: I
                do not want to change the current starting point in the grid, only because my first instruction would be 
                e.g. L 2.
                    Add to class constructor: (the coordinates into)
                            this.xCoordinateOfTail1InGrid; 
                            this.yCoordinateOfTail1InGrid; (create these attributes)
            2. repeat for rope-tail-objects 2-9.
...
//calculateRopeBridgeNrOfRowsAndColsAndStartingPoint
    ...
    movefRopeTailOnRopeBridgeOneStepAtATime(motionOfRopeHeadOfRopeBridge) {
        ...
        //set starting position (on the rope bridge) where the elves start to walk: 
        this.gridToPlotPositionOf9TailsWithForEachGridCellABooleanIsVisited[this.xCoordinateOfTailInGrid][this.yCoordinateOfTailInGrid] = 'tru';
        // log(this.gridToPlotPositionOf9TailsWithForEachGridCellABooleanIsVisited);
        ...
        switch(directionOfMovement){
                ...
                for (let i = 0; i < nrOfRopeHeadStepsOnRopeBridge; i++) {
                    ...
                    const calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD = (xLeadingKnot, yLeadingKnot, xFollowingTailKnot, yFollowingTailKnot) => {   
                        ...
                        //     log('right: head and tail adjacent, so tail not moving.')
                            ...
                            log(`U: tail goes south-east-south: `)
                            xFollowingTailKnot += 1;
                            yFollowingTailKnot += 1;
                            this.gridToPlotPositionOf9TailsWithForEachGridCellABooleanIsVisited[xFollowingTailKnot][yFollowingTailKnot] = 'tru';
                        } else if (xLeadingKnot - xFollowingTailKnot == 1 && // scope: only rope-tail 2-10. out-of-scope: rope-tail 1.
                            yLeadingKnot - yFollowingTailKnot == - 2 ) {
                            log(`U: tail goes south-west-south: `)
                            xFollowingTailKnot += 1;
                            yFollowingTailKnot -= 1;
                            this.gridToPlotPositionOf9TailsWithForEachGridCellABooleanIsVisited[xFollowingTailKnot][yFollowingTailKnot] = 'tru';                         
                        } else { console.warn(`fn movefRopeTailOnRopeBridgeOneStepAtATime: case D: else-statement:`)
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfHeadInGrid, this.yCoordinateOfHeadInGrid, this.xCoordinateOfTailInGrid, this.yCoordinateOfTailInGrid)

                    /*
                        goal: update rope-tail-coordinates so it can be reused for:
                        a) remainder of this instruction (e.g. R 4 in input1.txt):
                    */
                    this.xCoordinateOfTail1InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot[0];
                    this.yCoordinateOfTail1InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot[1];
                    /*
                        goal: update rope-tail-coordinates so it can be reused for:
                        a) the next instruction (e.g. U4, in input1.txt):
                    */
                    this.xCoordinateOfTailInGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot[0];
                    this.yCoordinateOfTailInGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot[1];
                
    
                    log(`D: move rope-tail NUMBER 2:`)
                    newCoordinatesOfRopeLeadingAndFollowingKnot = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid, this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid)
                    // /*
                    //     goal: update rope-tail-coordinates so it can be reused for:
                    //     a) the next instruction (e.g. R 4 in input1.txt):
                    // */
                    this.xCoordinateOfTail2InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot[0];
                    this.yCoordinateOfTail2InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot[1];
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot3 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid, this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid)
                    this.xCoordinateOfTail3InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot3[0];
                    this.yCoordinateOfTail3InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot3[1];
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot4 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid, this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid)
                    this.xCoordinateOfTail4InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot4[0];
                    this.yCoordinateOfTail4InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot4[1];
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot5 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail4InGrid, this.yCoordinateOfTailInGrid, this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid)
                    this.xCoordinateOfTail5InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot5[0];
                    this.yCoordinateOfTail5InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot5[1];
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot6 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid, this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid)
                    this.xCoordinateOfTail6InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot6[0];
                    this.yCoordinateOfTail6InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot6[1];
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot7 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid, this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid)
                    this.xCoordinateOfTail7InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot7[0];
                    this.yCoordinateOfTail7InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot7[1];
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot8 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid, this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid)
                    this.xCoordinateOfTail8InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot8[0];
                    this.yCoordinateOfTail8InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot8[1];
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot9 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid, this.xCoordinateOfTail9InGrid, this.yCoordinateOfTail9InGrid)
                    this.xCoordinateOfTail9InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot9[0];
                    this.yCoordinateOfTail9InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot9[1];
            ...
            case 'L':
                ...
                for (let i = 0; i < nrOfRopeHeadStepsOnRopeBridge; i++) {
                    ...
                    // this.yCoordinateOfTailInGrid = this.yCoordinateOfHeadInGrid;  
                    log(`for-loop: i: ${i}`);
                    log(`for-loop: nrOfRopeHeadStepsOnRopeBridge: ${nrOfRopeHeadStepsOnRopeBridge}`);
                    ...
                    const calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL = (xLeadingKnot, yLeadingKnot, xFollowingTailKnot, yFollowingTailKnot) => {   
                        ...
                        //     log('right: head and tail adjacent, so tail not moving.')
                            ...
                            yLeadingKnot - yFollowingTailKnot == -1 ) {
                            log(`U: tail goes south-south-west: `)
                            xFollowingTailKnot += 1;
                            yFollowingTailKnot -= 1;
                            this.gridToPlotPositionOf9TailsWithForEachGridCellABooleanIsVisited[xFollowingTailKnot][yFollowingTailKnot] = 'tru';                         
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfHeadInGrid, this.yCoordinateOfHeadInGrid, this.xCoordinateOfTailInGrid, this.yCoordinateOfTailInGrid)
                    ...
                    */
                    ...
                    newCoordinatesOfRopeLeadingAndFollowingKnot = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid, this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid)
                    // /*
                    //     goal: update rope-tail-coordinates so it can be reused for:
                    //     a) the next instruction (e.g. R 4 in input1.txt):
                    // */
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot3 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid, this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid)
                    this.xCoordinateOfTail3InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot3[0];
                    this.yCoordinateOfTail3InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot3[1];
                    log(`this.xCoordinateOfTail3InGrid: ${this.xCoordinateOfTail3InGrid}`);
                    log(`this.yCoordinateOfTail3InGrid: ${this.yCoordinateOfTail3InGrid}`);
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot4 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid, this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid)
                    this.xCoordinateOfTail4InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot4[0];
                    this.yCoordinateOfTail4InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot4[1];
                    log(`this.xCoordinateOfTail4InGrid: ${this.xCoordinateOfTail4InGrid}`);
                    log(`this.yCoordinateOfTail4InGrid: ${this.yCoordinateOfTail4InGrid}`);
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot5 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid, this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid)
                    this.xCoordinateOfTail5InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot5[0];
                    this.yCoordinateOfTail5InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot5[1];
                    log(`this.xCoordinateOfTail5InGrid: ${this.xCoordinateOfTail5InGrid}`);
                    log(`this.yCoordinateOfTail5InGrid: ${this.yCoordinateOfTail5InGrid}`);
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot6 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid, this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid)
                    this.xCoordinateOfTail6InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot6[0];
                    this.yCoordinateOfTail6InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot6[1];
                    log(`this.xCoordinateOfTail6InGrid: ${this.xCoordinateOfTail6InGrid}`);
                    log(`this.yCoordinateOfTail6InGrid: ${this.yCoordinateOfTail6InGrid}`);
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot7 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid, this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid)
                    this.xCoordinateOfTail7InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot7[0];
                    this.yCoordinateOfTail7InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot7[1];
                    log(`this.xCoordinateOfTail7InGrid: ${this.xCoordinateOfTail7InGrid}`);
                    log(`this.yCoordinateOfTail7InGrid: ${this.yCoordinateOfTail7InGrid}`);
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot8 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid, this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid)
                    this.xCoordinateOfTail8InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot8[0];
                    this.yCoordinateOfTail8InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot8[1];
                    log(`this.xCoordinateOfTail8InGrid: ${this.xCoordinateOfTail8InGrid}`);
                    log(`this.yCoordinateOfTail8InGrid: ${this.yCoordinateOfTail8InGrid}`);
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot9 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid, this.xCoordinateOfTail9InGrid, this.yCoordinateOfTail9InGrid)
                    this.xCoordinateOfTail9InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot9[0];
                    this.yCoordinateOfTail9InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot9[1];
                    log(`this.xCoordinateOfTail9InGrid: ${this.xCoordinateOfTail9InGrid}`);
                    log(`this.yCoordinateOfTail9InGrid: ${this.yCoordinateOfTail9InGrid}`);
            ...
            case 'R':
                ...
                // this.xCoordinateOfTailInGrid = this.xCoordinateOfHeadInGrid;
                    ...
                    log(`R: x,y head: ${this.xCoordinateOfHeadInGrid}, ${this.yCoordinateOfHeadInGrid} `);
                    log(`R: x,y tail:  ${this.xCoordinateOfTailInGrid} , ${this.yCoordinateOfTailInGrid}  `);  
                    /*
                        goal: update rope-head-coordinates so it can be reused for:
                        a) remainder of this instruction (e.g. R 4 in input1.txt)
                        b) the next instruction (e.g. U 4 in input1.txt):
                    */ 
                    this.yCoordinateOfHeadInGrid += 1;
                    log(`R: with updated yCoordinateOfHeadInGrid:`)
                    log(`R: x,y head: ${this.xCoordinateOfHeadInGrid}, ${this.yCoordinateOfHeadInGrid} `);
                    log(`R: x,y tail:  ${this.xCoordinateOfTailInGrid} , ${this.yCoordinateOfTailInGrid}  `);   
                    log('R: lets update the tail:')
                ...
                const calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR = (xLeadingKnot, yLeadingKnot, xFollowingTailKnot, yFollowingTailKnot) => {   
                    ...
                    //     log('right: head and tail adjacent, so tail not moving.')
                        ...
                        yLeadingKnot - yFollowingTailKnot == 1 ) {
                        log(`U: tail goes south-south-east: `)
                        xFollowingTailKnot += 1;
                        yFollowingTailKnot += 1;
                        this.gridToPlotPositionOf9TailsWithForEachGridCellABooleanIsVisited[xFollowingTailKnot][yFollowingTailKnot] = 'tru';   
                ...
                log(`here 1of2:`)
                let newCoordinatesOfRopeLeadingAndFollowingKnot = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfHeadInGrid, this.yCoordinateOfHeadInGrid, this.xCoordinateOfTailInGrid, this.yCoordinateOfTailInGrid)
                log(`here 2of2: `)
                /*
                    goal: update rope-tail-coordinates so it can be reused for:
                    a) remainder of this instruction (e.g. R 4 in input1.txt):
                ...
                */
                ...
                newCoordinatesOfRopeLeadingAndFollowingKnot = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid, this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid)
                /*
                    goal: update rope-tail-coordinates so it can be reused for:
                    a) the next instruction (e.g. R 4 in input1.txt):
                */
                ...
                let newCoordinatesOfRopeLeadingAndFollowingKnot3 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid, this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid)
                this.xCoordinateOfTail3InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot3[0];
                this.yCoordinateOfTail3InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot3[1];
                log(`this.xCoordinateOfTail3InGrid: ${this.xCoordinateOfTail3InGrid}`);
                log(`this.yCoordinateOfTail3InGrid: ${this.yCoordinateOfTail3InGrid}`);
                ...
                let newCoordinatesOfRopeLeadingAndFollowingKnot4 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid, this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid)
                this.xCoordinateOfTail4InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot4[0];
                this.yCoordinateOfTail4InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot4[1];
                log(`this.xCoordinateOfTail4InGrid: ${this.xCoordinateOfTail4InGrid}`);
                log(`this.yCoordinateOfTail4InGrid: ${this.yCoordinateOfTail4InGrid}`);
                ...
                let newCoordinatesOfRopeLeadingAndFollowingKnot5 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid, this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid)
                this.xCoordinateOfTail5InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot5[0];
                this.yCoordinateOfTail5InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot5[1];
                log(`this.xCoordinateOfTail5InGrid: ${this.xCoordinateOfTail5InGrid}`);
                log(`this.yCoordinateOfTail5InGrid: ${this.yCoordinateOfTail5InGrid}`);
                ...
                let newCoordinatesOfRopeLeadingAndFollowingKnot6 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid, this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid)
                this.xCoordinateOfTail6InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot6[0];
                this.yCoordinateOfTail6InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot6[1];
                log(`this.xCoordinateOfTail6InGrid: ${this.xCoordinateOfTail6InGrid}`);
                log(`this.yCoordinateOfTail6InGrid: ${this.yCoordinateOfTail6InGrid}`);
                ...
                let newCoordinatesOfRopeLeadingAndFollowingKnot7 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid, this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid)
                this.xCoordinateOfTail7InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot7[0];
                this.yCoordinateOfTail7InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot7[1];
                log(`this.xCoordinateOfTail7InGrid: ${this.xCoordinateOfTail7InGrid}`);
                log(`this.yCoordinateOfTail7InGrid: ${this.yCoordinateOfTail7InGrid}`);
                ...
                let newCoordinatesOfRopeLeadingAndFollowingKnot8 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid, this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid)
                this.xCoordinateOfTail8InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot8[0];
                this.yCoordinateOfTail8InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot8[1];
                log(`this.xCoordinateOfTail8InGrid: ${this.xCoordinateOfTail8InGrid}`);
                log(`this.yCoordinateOfTail8InGrid: ${this.yCoordinateOfTail8InGrid}`);
                ...
                let newCoordinatesOfRopeLeadingAndFollowingKnot9 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid, this.xCoordinateOfTail9InGrid, this.yCoordinateOfTail9InGrid)
                this.xCoordinateOfTail9InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot9[0];
                this.yCoordinateOfTail9InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot9[1];
                log(`this.xCoordinateOfTail9InGrid: ${this.xCoordinateOfTail9InGrid}`);
                log(`this.yCoordinateOfTail9InGrid: ${this.yCoordinateOfTail9InGrid}`);
            ...
            case 'U':
                ...
                for (let i = 0; i < nrOfRopeHeadStepsOnRopeBridge; i++) {
                    ...
                    log(`U: x,y head: ${this.xCoordinateOfHeadInGrid}, ${this.yCoordinateOfHeadInGrid} `);
                    log(`U: x,y tail:  ${this.xCoordinateOfTailInGrid} , ${this.yCoordinateOfTailInGrid}  `); 
                    ...
                    const calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU = (xLeadingKnot, yLeadingKnot, xFollowingTailKnot, yFollowingTailKnot) => {   
                        ...
                        //     log('right: head and tail adjacent, so tail not moving.')
                            ...
                            yFollowingTailKnot -= 1;
                            this.gridToPlotPositionOf9TailsWithForEachGridCellABooleanIsVisited[xFollowingTailKnot][yFollowingTailKnot] = 'tru';                        
                        } else { console.warn(`fn movefRopeTailOnRopeBridgeOneStepAtATime: case U`)
                        };
    
                        return [xFollowingTailKnot, yFollowingTailKnot]
                    }

                    let newCoordinatesOfRopeLeadingAndFollowingKnot = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfHeadInGrid, this.yCoordinateOfHeadInGrid, this.xCoordinateOfTailInGrid, this.yCoordinateOfTailInGrid)
                    ...
                    */
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot2 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid, this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid)
                    /*
                        goal: update rope-tail-coordinates so it can be reused for:
                        a) the next instruction (e.g. R 4 in input1.txt):
                    */
                    this.xCoordinateOfTail2InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot2[0];
                    this.yCoordinateOfTail2InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot2[1];
                    log(`this.xCoordinateOfTail2InGrid: ${this.xCoordinateOfTail2InGrid}`);
                    log(`this.yCoordinateOfTail2InGrid: ${this.yCoordinateOfTail2InGrid}`);
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot3 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid, this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid)
                    this.xCoordinateOfTail3InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot3[0];
                    this.yCoordinateOfTail3InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot3[1];
                    log(`this.xCoordinateOfTail3InGrid: ${this.xCoordinateOfTail3InGrid}`);
                    log(`this.yCoordinateOfTail3InGrid: ${this.yCoordinateOfTail3InGrid}`);
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot4 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid, this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid)
                    this.xCoordinateOfTail4InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot4[0];
                    this.yCoordinateOfTail4InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot4[1];
                    log(`this.xCoordinateOfTail4InGrid: ${this.xCoordinateOfTail4InGrid}`);
                    log(`this.yCoordinateOfTail4InGrid: ${this.yCoordinateOfTail4InGrid}`);
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot5 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid, this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid)
                    this.xCoordinateOfTail5InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot5[0];
                    this.yCoordinateOfTail5InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot5[1];
                    log(`this.xCoordinateOfTail5InGrid: ${this.xCoordinateOfTail5InGrid}`);
                    log(`this.yCoordinateOfTail5InGrid: ${this.yCoordinateOfTail5InGrid}`);
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot6 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid, this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid)
                    this.xCoordinateOfTail6InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot6[0];
                    this.yCoordinateOfTail6InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot6[1];
                    log(`this.xCoordinateOfTail6InGrid: ${this.xCoordinateOfTail6InGrid}`);
                    log(`this.yCoordinateOfTail6InGrid: ${this.yCoordinateOfTail6InGrid}`);
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot7 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid, this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid)
                    this.xCoordinateOfTail7InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot7[0];
                    this.yCoordinateOfTail7InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot7[1];
                    log(`this.xCoordinateOfTail7InGrid: ${this.xCoordinateOfTail7InGrid}`);
                    log(`this.yCoordinateOfTail7InGrid: ${this.yCoordinateOfTail7InGrid}`);
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot8 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid, this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid)
                    this.xCoordinateOfTail8InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot8[0];
                    this.yCoordinateOfTail8InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot8[1];
                    log(`this.xCoordinateOfTail8InGrid: ${this.xCoordinateOfTail8InGrid}`);
                    log(`this.yCoordinateOfTail8InGrid: ${this.yCoordinateOfTail8InGrid}`);
                    ...
                    let newCoordinatesOfRopeLeadingAndFollowingKnot9 = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid, this.xCoordinateOfTail9InGrid, this.yCoordinateOfTail9InGrid)
                    this.xCoordinateOfTail9InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot9[0];
                    this.yCoordinateOfTail9InGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot9[1];
                    log(`this.xCoordinateOfTail9InGrid: ${this.xCoordinateOfTail9InGrid}`);
                    log(`this.yCoordinateOfTail9InGrid: ${this.yCoordinateOfTail9InGrid}`);
