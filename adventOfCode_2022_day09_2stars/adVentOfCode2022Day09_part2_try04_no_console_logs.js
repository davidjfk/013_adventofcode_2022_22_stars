/*
    ...
    next: in try_05 comment out all console.//log-statements (otherwise vscode becomes too slow) and run the code.
    
    
    none, correct result of adventOfCode day 9 part 2 == 
...
const motionsOfRopeHeadOfRopeBridge = readFileSync("input2.txt", "utf-8").split('\r\n');
                ...
                for (let i = 0; i < nrOfRopeHeadStepsOnRopeBridge; i++) {
                    ...
                    const calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD = (xLeadingKnot, yLeadingKnot, xFollowingTailKnot, yFollowingTailKnot) => {   
                        ...
                        //     //log('right: head and tail adjacent, so tail not moving.')
                            ...
                            // console.warn(`fn movefRopeTailOnRopeBridgeOneStepAtATime: case D: else-statement:`)

                            //log(`fn movefRopeTailOnRopeBridgeOneStepAtATime: case D: `)
