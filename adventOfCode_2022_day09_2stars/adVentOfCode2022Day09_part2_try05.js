/*
    ...
    You must only count the grid positions that only tail 9 has visited.
    Currently I count them all...(total: 6365)...but that is not the question.
    
    solution: adjust how calculation takes place inside method movefRopeTailOnRopeBridgeOneStepAtATimeForEachInstructionFromInputFile (=== quick fix). (status done)

    goal: implement solution in part2_try05.js
    
    
    problem 1 of 2: counting goes wrong.
    ...
    e.g.    D 8
            ...
            (also with U instead of D)

            With R1 goes ok,  but with R2 or higher  goes wrong.

            2do: investigate (date: 230118: I have no idea.)
    ...
    problem analysis:
        ...
        head goes 8 down, then 2 to the right and then starts moving 6 down again.
        As a result of this behavior by the head, tail 8 goes south-east: i.e. down ( x+=1) and to the right (x+=1)
        Now tail 9 must move sout-east as well, but... it cannot, beause the code cannot handle the situation.
        What must still be implemented in all if-else-logic of 
        fn movefRopeTailOnRopeBridgeOneStepAtATimeForEachInstructionFromInputFile is:
        ...
        Similarly, north-east, north-west and south-west must also be implemented. (status: done)

        I have found this in the code as follows:
        (first iteration of D6:)

        D: move rope-tail NUMBER 7: :
        D: fn: calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD:
        D: for-loop: i: 0
        D: for-loop: nrOfRopeHeadStepsOnRopeBridge: 6
        D: xLeadingKnot: 5
        D: yLeadingKnot: 6
        D: xFollowingTailKnot: 4
        D: yFollowingTailKnot: 6
        fn movefRopeTailOnRopeBridgeOneStepAtATimeForEachInstructionFromInputFile: case D: else-statement:
        fn movefRopeTailOnRopeBridgeOneStepAtATimeForEachInstructionFromInputFile: case D:
        x,y head: 5, 4
        x,y tail:  6 , 6
        D: move rope-tail NUMBER 8: :
        D: fn: calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD:
        D: for-loop: i: 0
        D: for-loop: nrOfRopeHeadStepsOnRopeBridge: 6
        D: xLeadingKnot: 4
        D: yLeadingKnot: 6
        D: xFollowingTailKnot: 3
        D: yFollowingTailKnot: 6
        fn movefRopeTailOnRopeBridgeOneStepAtATimeForEachInstructionFromInputFile: case D: else-statement:
        fn movefRopeTailOnRopeBridgeOneStepAtATimeForEachInstructionFromInputFile: case D:
        x,y head: 4, 3
        x,y tail:  6 , 6
        D: move rope-tail NUMBER 9: :
        D: fn: calculateNewXAndYCoordinateOfTailKnot9WithVisitedGridCellCountInCaseD:
        D: for-loop: i: 0
        D: for-loop: nrOfRopeHeadStepsOnRopeBridge: 6
        D: xLeadingKnot: 3                  <-- here !! 
        D: yLeadingKnot: 6                  <-- here !!
        D: xFollowingTailKnot: 2            <-- here !!
        D: yFollowingTailKnot: 5            <-- here !!
        D: fn movefRopeTailOnRopeBridgeOneStepAtATimeForEachInstructionFromInputFile: case D: else-statement:
        D: fn movefRopeTailOnRopeBridgeOneStepAtATimeForEachInstructionFromInputFile: case D:
        D: x,y head: 3, 2
        D: x,y tail:  6 , 5
        ------------------next cell in loop of instruction-------------




        (second iteration of D6:)
        D: move rope-tail NUMBER 7: :
        D: fn: calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD:
        D: for-loop: i: 1
        D: for-loop: nrOfRopeHeadStepsOnRopeBridge: 6
        ...
        D: for-loop: i: 1
        D: for-loop: nrOfRopeHeadStepsOnRopeBridge: 6
        D: xLeadingKnot: 4          <-- here !!
        D: yLeadingKnot: 7          <-- here !!
        D: xFollowingTailKnot: 2    <-- here !!
        D: yFollowingTailKnot: 5    <-- here !!
        D: fn movefRopeTailOnRopeBridgeOneStepAtATimeForEachInstructionFromInputFile: case D: else-statement:
        D: fn movefRopeTailOnRopeBridgeOneStepAtATimeForEachInstructionFromInputFile: case D:
       ...
       problem 2of2: for input3.txt: 
            ...
            U 20
                ...
                the final result is not the same as that on https://adventofcode.com/2022/day/9

        The logging has provided me with  the following clue: (see logging in terminal for more context)

        L: move rope-tail NUMBER 6: :
        L: fn: calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL:
        L: for-loop: i: 3
        L: for-loop: nrOfRopeHeadStepsOnRopeBridge: 8
        L: xLeadingKnot: 11 <-- here !!
        L: yLeadingKnot: 15 <-- here !!
        L: xFollowingTailKnot: 13  <-- here !!
        L: yFollowingTailKnot: 15  <-- here !!
        L: fn movefRopeTailOnRopeBridgeOneStepAtATimeForEachInstructionFromInputFile: case L
        L: xFollowingTailKnot: (updated): 13  <-- here !!
        L: yFollowingTailKnot: (updated): 15  <-- here !!

                analysis: the code cannot handle this situation.
                solution: add in all if-else-logic of 
                fn movefRopeTailOnRopeBridgeOneStepAtATimeForEachInstructionFromInputFile (16 places in total variations of the following code snippet):
            ...
            But this failed change to the code has made me realize that the vector of xLeadingKnot - xFollowingTailKnot and yLeadingKnot - yFollowingTailKnot can 
            point into any direction inside all case statements of fn movefRopeTailOnRopeBridgeOneStepAtATimeForEachInstructionFromInputFile.

            solution/ 2do: create method calculateXAndYCoordinatesOfTail that combines ALL directions (south, north-west, etc.) !!
        ...
        switch(directionOfMovement){
            case 'D':
                ...
                for (let i = 0; i < nrOfRopeHeadStepsOnRopeBridge; i++) { 
                    ...
                    log(`D: fn: calculateNewXAndYCoordinateOfTailKnot: 2 or 3-10: `)
                    log(`D: for-loop: i: ${i}`);
                    log(`D: for-loop: nrOfRopeHeadStepsOnRopeBridge: ${nrOfRopeHeadStepsOnRopeBridge}`);
                    log(`D: output of previous instruction:`)
                    log(`D: x,y rope-head: ${this.xCoordinateOfHeadInGrid}, ${this.yCoordinateOfHeadInGrid} `);
                    log(`D: x,y rope-tail1:  ${this.xCoordinateOfTail1InGrid} , ${this.yCoordinateOfTail1InGrid}  `);                  
                    this.xCoordinateOfHeadInGrid += 1;
                    log(`U: updated xCoordinateOfHeadInGrid:`)
                    ...
                    let newCoordinatesOfRopeTail1inD = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfHeadInGrid, this.yCoordinateOfHeadInGrid, this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid)
                    ...
                    */
                    ...
                    let newCoordinatesOfRopeTail2inD = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid, this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid)
                    // /*
                    //     goal: update rope-tail-coordinates so it can be reused for:
                    ...
                    let newCoordinatesOfRopeTail3inD = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid, this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid)
                    ...
                    let newCoordinatesOfRopeTail4inD = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid, this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid)
                    ...
                    let newCoordinatesOfRopeTail5inD = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid, this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid)
                    ...
                    let newCoordinatesOfRopeTail6inD = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid, this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid)
                    ...
                    let newCoordinatesOfRopeTail7inD = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid, this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid)
                    ...
                    let newCoordinatesOfRopeTail8inD = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD(this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid, this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid)
                    ...
                    let newCoordinatesOfRopeTail9inD = calculateNewXAndYCoordinateOfTailKnot9WithVisitedGridCellCountInCaseD(this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid, this.xCoordinateOfTail9InGrid, this.yCoordinateOfTail9InGrid)
            ...
            case 'L':
                ...
                for (let i = 0; i < nrOfRopeHeadStepsOnRopeBridge; i++) {
                    log(`------------------next cell in loop of instruction----------------------------------------------------------------------`);
                    log(`L: fn: calculateNewXAndYCoordinateOfTailKnot: 2 or 3-10: `)
                    log(`L: for-loop: i: ${i}`);
                    log(`L: for-loop: nrOfRopeHeadStepsOnRopeBridge: ${nrOfRopeHeadStepsOnRopeBridge}`);
                    log(`L: output of previous instruction:`)
                    log(`L: x,y rope-head: ${this.xCoordinateOfHeadInGrid}, ${this.yCoordinateOfHeadInGrid} `);
                    log(`L: x,y rope-tail1:  ${this.xCoordinateOfTail1InGrid} , ${this.yCoordinateOfTail1InGrid}  `);                
                    this.yCoordinateOfHeadInGrid -= 1;
                    log(`L: updated xCoordinateOfHeadInGrid:`)
                    ...
                    let newCoordinatesOfRopeTail1inL = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfHeadInGrid, this.yCoordinateOfHeadInGrid, this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid)
                    /*
                        goal: update rope-tail-coordinates so it can be reused for:
                        a) remainder of this instruction (e.g. R 4 in input1.txt):
                        b) the next instruction (e.g. U4, in input1.txt):
                    */
                    ...
                    let newCoordinatesOfRopeTail2inL = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid, this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid)
                    // /*
                    //     goal: update rope-tail-coordinates so it can be reused for:
                    //     a) the next instruction (e.g. R 4 in input1.txt):
                    // */
                    ...
                    let newCoordinatesOfRopeTail3inL = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid, this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid)
                    ...
                    let newCoordinatesOfRopeTail4inL = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid, this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid)
                    ...
                    let newCoordinatesOfRopeTail5inL = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid, this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid)
                    ...
                    let newCoordinatesOfRopeTail6inL = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid, this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid)
                    ...
                    let newCoordinatesOfRopeTail7inL = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid, this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid)
                    ...
                    let newCoordinatesOfRopeTail8inL = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL(this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid, this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid)
                    ...
                    let newCoordinatesOfRopeTail9inL = calculateNewXAndYCoordinateOfTailKnot9WithVisitedGridCellCountInCaseL(this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid, this.xCoordinateOfTail9InGrid, this.yCoordinateOfTail9InGrid)
            ...
            case 'R':
                ...
                for (let i = 0; i < nrOfRopeHeadStepsOnRopeBridge; i++) {
                    log(`------------------next cell in loop of instruction--------------------------------------------------------------------------------------------`);
                    log(`R: fn: calculateNewXAndYCoordinateOfTailKnot: 2 or 3-10: `)
                    log(`R: for-loop: i: ${i}`);
                    log(`R: for-loop: nrOfRopeHeadStepsOnRopeBridge: ${nrOfRopeHeadStepsOnRopeBridge}`);
                    log(`R: output of previous instruction:`)
                    log(`R: x,y rope-head: ${this.xCoordinateOfHeadInGrid}, ${this.yCoordinateOfHeadInGrid} `);
                    log(`R: x,y rope-tail1:  ${this.xCoordinateOfTail1InGrid} , ${this.yCoordinateOfTail1InGrid}  `);  
                    /*
                    ...
                    */ 
                    this.yCoordinateOfHeadInGrid += 1;
                    log(`R: updated xCoordinateOfHeadInGrid:`)
                ...
                let newCoordinatesOfRopeTail1inR = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfHeadInGrid, this.yCoordinateOfHeadInGrid, this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid)
                /*
                    goal: update rope-tail-coordinates so it can be reused for:
                    a) remainder of this instruction (e.g. R 4 in input1.txt):
                    b) the next instruction (e.g. U4, in input1.txt):
                */
                ...
                let newCoordinatesOfRopeTail2inR = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid, this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid)
                // /*
                //     goal: update rope-tail-coordinates so it can be reused for:
                //     a) the next instruction (e.g. R 4 in input1.txt):
                // */
                ...
                let newCoordinatesOfRopeTail3inR = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid, this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid)
                ...
                let newCoordinatesOfRopeTail4inR = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid, this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid)
                ...
                let newCoordinatesOfRopeTail5inR = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid, this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid)
                ...
                let newCoordinatesOfRopeTail6inR = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid, this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid)
                ...
                let newCoordinatesOfRopeTail7inR = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid, this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid)
                ...
                let newCoordinatesOfRopeTail8inR = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR(this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid, this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid)
                ...
                let newCoordinatesOfRopeTail9inR = calculateNewXAndYCoordinateOfTailKnot9WithVisitedGridCellCountInCaseR(this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid, this.xCoordinateOfTail9InGrid, this.yCoordinateOfTail9InGrid)
            ...
            case 'U':
                ...
                for (let i = 0; i < nrOfRopeHeadStepsOnRopeBridge; i++) {
                    log(`------------------next cell in loop of instruction----------------------------------------------------------------------------------------------------`);
                    log(`U: fn: calculateNewXAndYCoordinateOfTailKnot: 2 or 3-10: `)
                    log(`U: for-loop: i: ${i}`);
                    log(`U: for-loop: nrOfRopeHeadStepsOnRopeBridge: ${nrOfRopeHeadStepsOnRopeBridge}`);
                    log(`U: output of previous instruction:`)
                    log(`U: x,y rope-head: ${this.xCoordinateOfHeadInGrid}, ${this.yCoordinateOfHeadInGrid} `);
                    log(`U: x,y rope-tail1:  ${this.xCoordinateOfTail1InGrid} , ${this.yCoordinateOfTail1InGrid}  `); 
                    ...
                    let newCoordinatesOfRopeTail1inU = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfHeadInGrid, this.yCoordinateOfHeadInGrid, this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid)
                    /*
                        goal: update rope-tail-coordinates so it can be reused for:
                        a) remainder of this instruction (e.g. R 4 in input1.txt):
                        b) the next instruction (e.g. U4, in input1.txt):
                    */
                    ...
                    let newCoordinatesOfRopeTail2inU = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid, this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid)
                    // /*
                    //     goal: update rope-tail-coordinates so it can be reused for:
                    //     a) the next instruction (e.g. R 4 in input1.txt):
                    // */
                    ...
                    let newCoordinatesOfRopeTail3inU = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid, this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid)
                    ...
                    let newCoordinatesOfRopeTail4inU = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail3InGrid, this.yCoordinateOfTail3InGrid, this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid)
                    ...
                    let newCoordinatesOfRopeTail5inU = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail4InGrid, this.yCoordinateOfTail4InGrid, this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid)
                    ...
                    let newCoordinatesOfRopeTail6inU = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail5InGrid, this.yCoordinateOfTail5InGrid, this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid)
                    ...
                    let newCoordinatesOfRopeTail7inU = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail6InGrid, this.yCoordinateOfTail6InGrid, this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid)
                    ...
                    let newCoordinatesOfRopeTail8inU = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail7InGrid, this.yCoordinateOfTail7InGrid, this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid)
                    ...
                    let newCoordinatesOfRopeTail9inU = calculateNewXAndYCoordinateOfTailKnot9WithVisitedGridCellCountInCaseU(this.xCoordinateOfTail8InGrid, this.yCoordinateOfTail8InGrid, this.xCoordinateOfTail9InGrid, this.yCoordinateOfTail9InGrid)
