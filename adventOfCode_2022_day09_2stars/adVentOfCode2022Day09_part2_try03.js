/*
    ...
    GOAL: implement STEP1-3.
    status: fn calculateNewXAndYCoordinateOfFollowingTailKnot is working for case L, D and U of method movefRopeTailOnRopeBridgeOneStepAtATime as well (cas R was already working).
    inputfile1.txt with sample data from day9 part 1 of https://adventofcode.com/2022/day/9 still results in 13 (ok)

    next: (piece de resistance :) ) make the code work with 1 rope-head-object and 9 rope-tails instead of the current
        ...
        switch(directionOfMovement){
            case 'D':
                ...
                for (let i = 0; i < nrOfRopeHeadStepsOnRopeBridge; i++) {
                    ...
                    const calculateNewXAndYCoordinateOfFollowingTailKnotInCaseD = (xLeadingKnot, yLeadingKnot, xFollowingTailKnot, yFollowingTailKnot) => {   
                        ...
                        log(`U: xLeadingKnot: ${yLeadingKnot}`);
                    ...
                    */
                    ...
                    this.yCoordinateOfTailI1nGrid =  newCoordinatesOfRopeLeadingAndFollowingKnot[1];
                    /*
                        goal: update rope-tail-coordinates so it can be reused for:
                    ...
                    */
                    ...
                    // now repeat the steps for rope-tail NUMBER 2: 
                    // newCoordinatesOfRopeLeadingAndFollowingKnot = calculateNewXAndYCoordinateOfFollowingTailKnot(this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid, this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid)
                    // /*
                    //     goal: update rope-tail-coordinates so it can be reused for:
                    ...
                    /*
                        ...
                        3. set in gridToPlotPositionOfTail position of the new tail to boolean 'tru'. 
                    */

                        // log(`D: xLeadingKnot: ${xLeadingKnot}`);
                        // log(`D: xLeadingKnot: ${yLeadingKnot}`);
            ...
            case 'L':
                ...
                for (let i = 0; i < nrOfRopeHeadStepsOnRopeBridge; i++) {
                    ...
                    const calculateNewXAndYCoordinateOfFollowingTailKnotInCaseL = (xLeadingKnot, yLeadingKnot, xFollowingTailKnot, yFollowingTailKnot) => {   
                        ...
                        log(`L: xLeadingKnot: ${yLeadingKnot}`);    
                        if(xLeadingKnot - xFollowingTailKnot == 0 && 
                           yLeadingKnot - yFollowingTailKnot == 0)
                        {
                            log('right: head on top of tail')
            ...
            case 'R':
                ...
                const calculateNewXAndYCoordinateOfFollowingTailKnotInCaseR = (xLeadingKnot, yLeadingKnot, xFollowingTailKnot, yFollowingTailKnot) => {   
                    ...
                    log(`R: xLeadingKnot: ${yLeadingKnot}`);
                ...
                */
                ...
                // log(`R: now repeat the steps for rope-tail NUMBER 2:`)
            ...
            case 'U':
                ...
                for (let i = 0; i < nrOfRopeHeadStepsOnRopeBridge; i++) {
                    ...
                    */
                    ...
                    // // now repeat the steps for rope-tail NUMBER 2: 
                    // newCoordinatesOfRopeLeadingAndFollowingKnot = calculateNewXAndYCoordinateOfFollowingTailKnotInCaseU(this.xCoordinateOfTail1InGrid, this.yCoordinateOfTail1InGrid, this.xCoordinateOfTail2InGrid, this.yCoordinateOfTail2InGrid)
                    // /*
                    //     goal: update rope-tail-coordinates so it can be reused for:
                    //     a) the next instruction (e.g. R 4 in input1.txt):
                    // */
