...
/*
    ...
    solution-step 2: this code is correct, but has too many console.log-statements. Run try_07 
    with less console.log-statements instead. 

    status: comment out console.log-statements. (ctrl+f)
*/
