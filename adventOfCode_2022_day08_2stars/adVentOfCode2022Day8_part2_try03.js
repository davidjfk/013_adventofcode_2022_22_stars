...
/*
    ...
    (from the future: if (tree under investigation is smaller than iterated tree (from col or row from the grid))  { scenicScore = 1 }
                But in this file it is still scenicScore = 0.
    )
    status: in progress
*/
