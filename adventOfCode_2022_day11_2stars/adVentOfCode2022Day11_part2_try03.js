...
class GameOfKeepAwayPlayedByMonkeys {
    constructor(itemsWithEachMonkey0, itemsWithEachMonkey1, itemsWithEachMonkey2, itemsWithEachMonkey3) {
        // this.itemsWithEachMonkey = itemsWithEachMonkey;
        // add attributes below for improved readability of the code: 
        this.worryLevelOfItemsThatAreControledByMonkey0 = itemsWithEachMonkey0;
        this.worryLevelOfItemsThatAreControledByMonkey1 = itemsWithEachMonkey1;
        this.worryLevelOfItemsThatAreControledByMonkey2 = itemsWithEachMonkey2;
        this.worryLevelOfItemsThatAreControledByMonkey3 = itemsWithEachMonkey3;
...
let itemsWithEachMonkey0 = arrayWithBigInts[0];
let itemsWithEachMonkey1 = arrayWithBigInts[1];
let itemsWithEachMonkey2 = arrayWithBigInts[2];
let itemsWithEachMonkey3 = arrayWithBigInts[3];

const gameOfKeepAwayPlayedByMonkeys = new GameOfKeepAwayPlayedByMonkeys(itemsWithEachMonkey0, itemsWithEachMonkey1, itemsWithEachMonkey2, itemsWithEachMonkey3);
