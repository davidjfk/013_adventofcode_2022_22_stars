/*  
    ...
    step 3: convert array 'inputFromFile' into array with nrs.
    status: done

    step 4: convert each  nr into object  with nr (just like in the grid in previous file)
    status: done
...
let adventOfCodeGrid = arrayAsArrayWithSubArrays.map((subArray) => {
    return subArray
    .toString().split("")
...
// throw away -------------------
// inputFromFile does not seem to be an array, although it console.logs with []
let array1 = Array.from(inputFromFile)
